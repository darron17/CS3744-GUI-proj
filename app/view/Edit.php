    ...
    <div id="content">
      <div id="content-left">
        ...
        <form id="editNews" method="POST" action="<?= BASE_URL ?>/Edit/process<?= $_GET['storyID'] ?>">
          <h2>Post Title</h2>
          <input class="title" name="title" type="text" placeholder="Type title here">

          <h2>Body</h2>
          <textarea class="body" name="body" placeholder="Type content here"></textarea>

          <h2 class="description">Description</h2>
          <h2 class="links">Links</h2>
          <h2 class="image">Image</h2>

          <textarea class="descBox" name="description" placeholder="Type short description here"></textarea>
